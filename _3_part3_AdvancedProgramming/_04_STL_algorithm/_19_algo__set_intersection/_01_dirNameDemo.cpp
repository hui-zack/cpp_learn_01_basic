// Create by hui on 2022/12/15 1:16
// Code describe: 
// Keyword      : 
...
int main() {
    ...
    vector<int> dstVec;
    /* 19-1 使用set_intersection取两个容器的元素交集 */
    dstVec.resize(min(srcVec1.size(), srcVec2.size()));
    const vector<int>::iterator & itEnd = set_intersection(srcVec1.begin(), srcVec1.end(),
    ...
    printVector("resultVec", resultVec);
